...
public partial class Attractor : Area3D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        foreach (RigidBody3D body in bodies)
        {
            ...
            float angle = body.LinearVelocity.SignedAngleTo(body.GlobalPosition.DirectionTo(pl.GlobalPosition), Vector3.Up);
            body.LinearVelocity = body.LinearVelocity.Rotated(Vector3.Up, angle);
        }
    }
