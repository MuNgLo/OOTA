...
/// Set FieldTarget to the exact field name in the class definition you want to control.(Or Property)
/// Remember that the label for the setting's name need to be named "FieldName" for this script to pick it up (It does???! Yes. As the actual Name)
